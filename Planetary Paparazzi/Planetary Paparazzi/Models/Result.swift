...
struct BlockData: Hashable, Codable, Identifiable {
    // struct for each individual image/card
    var id: UUID = UUID()
    let content: Result
}
...
struct Result: Hashable, Codable,  Identifiable {
    ...
    struct Error: Decodable {
        // struct to print error codes to the console
        var code: Int
        var msg: String
